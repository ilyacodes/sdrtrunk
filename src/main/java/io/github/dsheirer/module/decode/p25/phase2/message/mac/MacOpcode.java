...
public enum MacOpcode
{
    ...
    MOTOROLA_91_GROUP_SERVICES_HEADER(Vendor.MOTOROLA, 145, "MOTOROLA GROUP SERVICES HEADER", 17),
    MOTOROLA_92_GROUP_TEXT_DATA_BLOCK(Vendor.MOTOROLA, 146, "MOTOROLA GROUP TEXT DATA BLOCK", 17),
