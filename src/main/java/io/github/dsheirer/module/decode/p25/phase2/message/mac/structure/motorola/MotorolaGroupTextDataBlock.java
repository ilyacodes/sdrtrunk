...
/**
 * Motorola Group Text continuation block Opcode 146 (0x92).  This follows a Motorola Group Services header message.
 *
 ...
 */
public class MotorolaGroupTextDataBlock extends MacStructureVendor
{
     ...
     */
    public MotorolaGroupTextDataBlock(CorrectedBinaryMessage message, int offset)
    {
    ...
    public String toString()
    {
        ...
        sb.append("MOTOROLA GROUP TEXT DATA BLOCK:").append(getBlockNumber());
