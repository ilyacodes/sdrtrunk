...
/**
 * Motorola Link Control opcode 0x16 (22).  This is possibly a radio reprogramming record segment that is used
 * in combination with LCO 0x15.  See notes in header of LCMotorolaRadioReprogramHeader class.
 */
public class LCMotorolaGroupTextDataBlock extends LinkControlWord
{
     ...
     * @param message
     */
    public LCMotorolaGroupTextDataBlock(CorrectedBinaryMessage message)
    {
        super(message);
    }
