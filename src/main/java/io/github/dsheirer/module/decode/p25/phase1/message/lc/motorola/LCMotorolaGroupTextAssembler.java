 ...
 */
public class LCMotorolaGroupTextAssembler
{
    private static final int DATA_BLOCK_FRAGMENT_LENGTH = 44;
    private LCMotorolaGroupServicesHeader mHeader;
    private Map<Integer, LCMotorolaGroupTextDataBlock> mDataBlocks = new HashMap<>();
     ...
     */
    public LCMotorolaGroupTextAssembler()
    {
    }
    ...
    public boolean add(LinkControlWord lcw, long timestamp)
    {
        ...
        else if(lcw instanceof LCMotorolaGroupTextDataBlock block)
        {
            mMostRecentTimestamp = timestamp;
    ...
    public MotorolaGroupTextComplete assemble() throws IllegalStateException
    {
        ...
        for(int x = 1; x <= dataBlockCount; x++)
        {
            LCMotorolaGroupTextDataBlock block = mDataBlocks.get(x);
